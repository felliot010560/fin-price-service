...
public class ReceivedExpirationsAndStrikeEvent extends ApplicationEvent {
    ...
    public ReceivedExpirationsAndStrikeEvent(Object source, String exchange, int underlyingConId, String tradingClass, String multiplier, Set<String> expirations, Set<Double> strikes) {
        super(source);
